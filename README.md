...
Install the **_Windows Terminal_** app available in Microsoft Store.
...
You DON'T need to follow the steps of the instalation.

> [!IMPORTANT]
> Just copy the lines inside `.zshrc` into your `~/.zshrc` for the specific configuration.
